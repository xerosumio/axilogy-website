...
import { ChevronRight, Server, FileText, ImageIcon, Zap, Shield, DollarSign } from "lucide-react"
  ...
  return (
    <main className="bg-gray-900 min-h-screen">
          ...
          <div className="max-w-3xl">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              ...
              <p className="text-xl md:text-2xl text-white/80 mb-8">
                A powerful, in-house AI solution developed by NATON, leveraging the open-source generative AI model,
                OLAMA. Experience the future of decentralized AI computing.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Create high-quality content, such as articles, marketing copy, and creative writing.",
                icon: FileText,
              },
              {
                title: "Data Analysis",
                description: "Analyze and extract key information from documents, improving efficiency and accuracy.",
                icon: Zap,
              },
              {
                title: "Image Generation",
                description: "Create simple images and visuals to support content marketing and design needs.",
                icon: ImageIcon,
              },
              {
                title: "Easy-to-Use",
                description: "Designed to be user-friendly and easy to integrate into existing business workflows.",
                icon: Zap,
              },
              {
                title: "Scalable and Customizable",
                description: "Easily scaled to meet evolving needs and customized to specific requirements.",
                icon: Zap,
              },
            ].map((feature, index) => (
              <motion.div
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-20">
          <h2 className="text-4xl font-bold text-white mb-12 text-center">Benefits</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                title: "Enhanced Productivity",
                description: "Automate tasks, streamline workflows, and increase efficiency.",
                icon: Zap,
              },
              {
                title: "Increased Creativity",
                description: "Unlock new creative possibilities with AI-powered content generation.",
                icon: ImageIcon,
              },
              {
                title: "Improved Data Security",
                description: "Protect sensitive data and maintain full control over your information.",
                icon: Shield,
              },
              {
              ...
              },
              {
                ...
                description: "Eliminate the need for expensive cloud subscriptions and reduce operational expenses.",
                icon: DollarSign,
              },
              {
                title: "Competitive Advantage",
                description: "Gain a competitive edge by leveraging the power of AI within your own infrastructure.",
                icon: Zap,
              },
            ].map((benefit, index) => (
              <motion.div
      ...
      >
        ...
        <div className="container mx-auto px-4 text-center relative z-20">
          <h2 className="text-4xl font-bold text-white mb-6">Ready to Empower Your Business with AI?</h2>
          <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
            CubyAI empowers businesses to harness the power of AI while maintaining data security and control. It's a
            valuable tool for companies looking to enhance their operations, improve efficiency, and unlock new
